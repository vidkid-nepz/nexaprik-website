...
export const metadata = {
    title: "Hiking Destinations in Nepal",
    description: "Explore our collection of day hikes and easy walking trails with stunning mountain views",
};

const getDestinations = () => {
    try {
        return require("@/data/destinations.json").filter((d: any) => d.category === 'hiking');
    } catch {
        return [];
    }
};
            ...
            <section className="relative h-[50vh] flex items-center justify-center bg-gradient-to-r from-primary-900 to-primary-800">
                <Container className="relative z-10 text-center text-white">
                    ...
                    <p className="text-xl text-primary-100 max-w-3xl mx-auto">
                        Perfect for families and casual trekkers - explore Nepal's natural beauty
                        on easy day hikes with magnificent views
                    </p>
                </Container>
            </section>
                ...
                <Container>
                    <div className="mb-8">
                        <p className="text-gray-600 text-lg">
                            Showing {destinations.length} hiking {destinations.length === 1 ? 'destination' : 'destinations'}
                        </p>
                    </div>
                    ...
                    {destinations.length === 0 && (
                        <div className="text-center py-16">
                            <p className="text-gray-500 text-lg">No hiking destinations available at the moment. Check back soon!</p>
                        </div>
                    )}
                </Container>
            </section>
            ...
            <section className="py-16 bg-primary-900 text-white">
                <Container className="text-center">
                    ...
                    <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
                        Our hiking destinations offer stunning views without the challenges of multi-day treks
                    </p>
                    <Link href="/contact">
