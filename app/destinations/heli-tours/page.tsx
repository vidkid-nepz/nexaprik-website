...
import { MapPin, Clock, Star, Users, Plane, ChevronRight } from "lucide-react";

export const metadata = {
    title: "Helicopter Tours in Nepal",
    description: "Experience the Himalayas from above with our luxury helicopter tours - Everest, Annapurna, and more",
};

const getDestinations = () => {
    try {
        return require("@/data/destinations.json").filter((d: any) => d.category === 'heli-tour');
    } catch {
        return [];
    }
};
            ...
            <section className="relative h-[50vh] flex items-center justify-center bg-gradient-to-r from-primary-900 to-primary-800">
                <Container className="relative z-10 text-center text-white">
                    <Badge className="mb-4 bg-accent-600 text-white border-none text-lg px-6 py-2">
                        🚁 Luxury Aerial Adventures
                    </Badge>
                    <h1 className="font-heading font-bold text-5xl md:text-6xl mb-6">
                        Helicopter Tours
                    </h1>
                    <p className="text-xl text-primary-100 max-w-3xl mx-auto">
                        Soar above the world's highest peaks in ultimate luxury -
                        experience Mount Everest and the Himalayas like never before
                    </p>
                </Container>
            </section>
                ...
                <Container>
                    <div className="mb-8">
                        <p className="text-gray-600 text-lg">
                            Showing {destinations.length} helicopter {destinations.length === 1 ? 'tour' : 'tours'}
                        </p>
                    </div>
                            ...
                            <Card key={destination.id} hover className="h-full flex flex-col group">
                                <div className="relative h-64 overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4 right-4 flex justify-between">
                                        ...
                                        <Badge className="bg-purple-600 text-white border-none ml-auto">
                                            🚁 Premium
                                        </Badge>
                                    </div>
                                ...
                                <CardContent className="flex-1 flex flex-col">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Plane size={16} className="text-accent-600" />
                                            <span className="text-gray-700">Helicopter</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                    ...
                    {destinations.length === 0 && (
                        <div className="text-center py-16">
                            <p className="text-gray-500 text-lg">Helicopter tours coming soon! Contact us for custom charters.</p>
                        </div>
                    )}
                </Container>
            </section>
            ...
            <section className="py-16 bg-primary-900 text-white">
                <Container className="text-center">
                    ...
                    <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
                        Book your private helicopter tour and witness the majesty of the Himalayas in unparalleled comfort
                    </p>
                    <Link href="/contact">
